...
多厂商 AI API 余额与用量监控桌面悬浮窗工具。

支持 **DeepSeek** · **StepFun** · **云知声 (Unisound)** · **MiniMax** 四家厂商的 API Key 余额查询与用量追踪。

## 下载安装

[**→ 下载最新版（v1.8.0）**](https://github.com/xsh2026/api-monitor/releases/latest)
...
- **用量追踪** — DeepSeek 支持按日查询 token 消耗与费用（趋势图表展示）
