  ...
  if (viewMode === 'minimal') {
    return (
      ...
      >
        ...
        <span className="text-[10px] text-[rgb(var(--text-secondary))]">用量</span>
    ...
    >
      ...
      <div className="relative flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs font-medium text-[rgb(var(--text-secondary))]">用量概览</div>
            <div className="text-[10px] text-[rgb(var(--text-tertiary))]">{summary.records.length} 条记录</div>
          </div>
        </div>
      </div>
      ...
      <div className="relative grid grid-cols-2 gap-2.5 mb-3">
        <div className="p-3 rounded-xl bg-[rgb(var(--surface)/0.5)] border border-[rgb(var(--border-subtle)/0.04)]">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[10px] text-[rgb(var(--text-tertiary))]">总 Token</span>
          </div>
          {loading ? (
        ...
        <div className="p-3 rounded-xl bg-[rgb(var(--surface)/0.5)] border border-[rgb(var(--border-subtle)/0.04)]">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span className="text-[10px] text-[rgb(var(--text-tertiary))]">总费用</span>
          </div>
          {loading ? (
            <span className="skeleton inline-block w-16 h-6" />
          ) : (
